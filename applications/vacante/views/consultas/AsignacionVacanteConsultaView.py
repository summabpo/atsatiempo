...
def consulta_asignacion_vacante_id(vacante_id):
    #consultar vacante
    asingacion_vacante = Cli056AplicacionVacante.objects.select_related(
        'candidato_101',
        'vacante_id_052',
        ...
        '-id'
    ).filter(vacante_id_052=vacante_id)

    #consultar aplicaciones
    return asingacion_vacante

#Vacantes asgiandas del candidato
def consulta_asignacion_vacante_candidato(candidato_id):
    #consultar vacante
    asignacion_vacante = Cli056AplicacionVacante.objects.select_related(
        'candidato_101',
        'vacante_id_052',
        'vacante_id_052__cliente_id_051',
        'vacante_id_052__ciudad',
        ...
        aplicacion_vacante_estado = Case(
            When(estado_aplicacion=1,  then=Value('Postulado')),
            When(estado_aplicacion=2,  then=Value('En Proceso')),
            When(estado_aplicacion=3,  then=Value('En Proceso')),
            When(estado_aplicacion=4,  then=Value('No Apto')),
            When(estado_aplicacion=5,  then=Value('En Proceso')),
            When(estado_aplicacion=6,  then=Value('En Proceso')),
            When(estado_aplicacion=7,  then=Value('No Apto')),
            When(estado_aplicacion=8,  then=Value('Seleccionado')),
            When(estado_aplicacion=9,  then=Value('Finalizada')),
            When(estado_aplicacion=10, then=Value('Cancelada')),
            When(estado_aplicacion=11, then=Value('Desiste')),
        ...
        '-id'
    ).filter(candidato_101=candidato_id)

    print(asignacion_vacante)
    #consultar aplicaciones
    return asignacion_vacante