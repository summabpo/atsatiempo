        ...
        self.helper.layout = Layout(
            Div(
                Div(
                    ...
                    Div('tipo_estudio', css_class='col-lg-12'),
                    Div('institucion', css_class='col-lg-12'),
                    Div('profesion_estudio', css_class='col-lg-12'),
                    Div('estado_estudios', css_class='col-lg-12'),
                    Div('titulo', css_class='col-lg-12 campo-graduado'),
                    Div('fecha_inicial', css_class='col-lg-6 campo-no-aplazado'),
                    Div('fecha_final', css_class='col-lg-6 campo-graduado campo-aplazado'),
                    Div('ciudad_id_004', css_class='col-lg-12'),
                    # Div('carrera', css_class='col-12'),
                    Div('certificacion', css_class='col-lg-12 campo-graduado'),
