...
ESTADO_APLICACION_CHOICES_STATIC = [
    ...
    (5, 'Acciones Desicivas Programadas'),
    (6, 'Acciones Desicivas Aprobadas'),
    (7, 'Acciones Desicivas No Aprobadas'),
    (8, 'Seleccionado'),
    (9, 'Finalizada'),
    (10, 'Cancelada'),
    (11, 'Desiste'),
...
ESTADO_APLICACION_COLOR_STATIC = {
    ...
    5: ('Acciones Desicivas Programadas', 'info'),
    6: ('Acciones Desicivas Aprobadas', 'success'),
    7: ('Acciones Desicivas No Aprobadas', 'danger'),
