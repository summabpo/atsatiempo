# Generated by Django 5.0.6 on 2024-09-09 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuarios.grupo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_expiracion', models.DateTimeField(default=datetime.datetime(2024, 9, 10, 16, 51, 30, 407517, tzinfo=datetime.timezone.utc))),
